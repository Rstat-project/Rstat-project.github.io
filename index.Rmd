...
**Windows使用者務必安裝於"C:\\Program Files"之外的路徑**

- (1)初步安裝完成者請自行下載[基礎 R 語法寫作示範](https://rstat-project.github.io/seed_courses/base_R_demo.zip)；(2)解壓縮後以Rstudio開啟"base_R_demo.Rmd"；(3)按下視窗上方的"Knit"按鈕，能生成網頁檔"base_R_demo.html"表示你的R及Rstudio可正常執行。(過程中將安裝必要套件，提示按yes或繼續即可)
